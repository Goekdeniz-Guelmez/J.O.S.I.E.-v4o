...
# Gibt native implmentation in MLX
...
class SimpleTokenizer(object):
    def __init__(self, bpe_path: str, context_length=77):
        ...
        self.pat = re.compile(
            r"""<\|im_start\|>|<\|im_end\|>|'s|'t|'re|'ve|'m|'ll|'d|[\p{L}]+|[\p{N}]|[^\s\p{L}\p{N}]+""",
            re.IGNORECASE,
        )
        self.context_length = context_length
    ...
    def __call__(self, texts, context_length=None):
        ...
        sot_token = self.encoder["<|im_start|>"]
        eot_token = self.encoder["<|im_end|>"]
