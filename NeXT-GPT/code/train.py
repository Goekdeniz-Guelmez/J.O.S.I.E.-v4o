...
def parser_args():
    ...
    parser.add_argument('--save_path', type=str, default='../ckpt/delta_ckpt/nextgpt/model/')
    parser.add_argument('--log_path', type=str, default='../ckpt/delta_ckpt/nextgpt/model/log/')
    parser.add_argument('--assets_path', type=str, default='./assets/')

    # model configurations
    parser.add_argument('--max_length', type=int, default=128)  # the maximum input sequence length for LLMs
